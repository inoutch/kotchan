...
import io.github.inoutch.kotchan.utility.collection.Queue
...
class Dijkstra {
    companion object {
        ...
        fun search(start: Point, end: Point, isWall: (x: Int, y: Int) -> Boolean): List<Point> {
            return search(start, listOf(end), isWall)
        }

        fun search(start: Point, ends: List<Point>, isWall: (x: Int, y: Int) -> Boolean): List<Point> {
