...
open class SpriteAtlas(material: Material, private val textureAtlas: TextureAtlas, size: Vector2? = null)
    : Sprite(material, size ?: textureAtlas.frame(0)?.frame?.size ?: throw Error("no frame at texture atlas")) {
